    ...
    <div class="col-lg-8">
        <div class="form-card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Data Dosen</h5>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ route('dosen.update', $dosen) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="bidang_keahlian" class="form-control" value="{{ old('bidang_keahlian', $dosen->bidang_keahlian) }}" required>
                        </div>
                        <div class="col-md-6">
